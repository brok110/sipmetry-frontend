 ...
 * Recipe vecs are 0–3 scale from backend (clamp01to3 in server.js).
 *
...
const TAG_CONFIG: Array<{
  ...
  { key: "fruity",          label: "Fruity",      threshold: 2.0, priority: 5 },
  { key: "herbal",          label: "Herbal",      threshold: 2.0, priority: 6 },
  { key: "smoky",           label: "Smoky",       threshold: 1.5, priority: 7 },
  { key: "fizz",            label: "Fizzy",       threshold: 2.0, priority: 8 },
  { key: "body",            label: "Full-bodied", threshold: 2.0, priority: 9 },
  { key: "floral",          label: "Floral",      threshold: 1.5, priority: 10 },
  { key: "spicy",           label: "Spicy",       threshold: 1.5, priority: 11 },
  { key: "aromaIntensity",  label: "Aromatic",    threshold: 2.0, priority: 12 },
];
