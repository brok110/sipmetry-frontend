...
- Attempt to interfere with or disrupt the app's services or servers
- Reverse-engineer, decompile, or disassemble the app
- Use automated means to access the app beyond its intended functionality, including scraping, data extraction, or systematic abuse of rate limits
- Submit false, misleading, or harmful content through the app
- Misuse, redistribute, or commercially exploit AI-generated outputs from the app
...
We may use User Content in aggregated or de-identified form for analytics, research, and service improvement. Aggregated or de-identified data that cannot reasonably be used to identify you is not subject to the data deletion provisions in our [Privacy Policy](https://brok110.github.io/sipmetry-frontend/privacy).
...
The license granted in this section is subject to the account deletion provisions in our [Privacy Policy](https://brok110.github.io/sipmetry-frontend/privacy). Upon account deletion, Sipmetry will delete your personally identifiable data as described in the Privacy Policy. However, the license granted herein shall continue to apply to any User Content that has been aggregated or de-identified prior to deletion in a form that cannot reasonably be used to identify you.

## 8. Intellectual Property

All content, design, and functionality of Sipmetry are owned by us and protected by applicable intellectual property laws. You may not copy, modify, or distribute any part of the app without our written consent. Data you create within the app (such as your inventory and preferences) remains associated with your account and is subject to our [Privacy Policy](https://brok110.github.io/sipmetry-frontend/privacy).
...
- **DAMAGES RELATED TO RELIANCE ON AI-GENERATED RECOMMENDATIONS, INCLUDING INCORRECT BOTTLE OR INGREDIENT IDENTIFICATION**
- **HEALTH ISSUES, ALLERGIC REACTIONS, OR ADVERSE EFFECTS RESULTING FROM THE PREPARATION OR CONSUMPTION OF COCKTAILS BASED ON APP DATA**
- **LOSS OF DATA OR UNAUTHORIZED ACCESS TO YOUR ACCOUNT**
- **SERVICE INTERRUPTIONS, ERRORS, OR FAILURES CAUSED BY THIRD-PARTY SERVICE PROVIDERS**
...
- These Terms are between you and Sipmetry only, and not with Apple Inc. ("Apple"). Sipmetry, not Apple, is solely responsible for the app and its content.
...
- In the event of any third-party claim that the app or your possession and use of the app infringes that third party's intellectual property rights, Sipmetry, not Apple, will be solely responsible for the investigation, defense, settlement, and discharge of any such claim.
